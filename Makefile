# This Makefile is for the POE::SAPI::HandySubs extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/POE/SAPI/HandySubs.pm]
#     AUTHOR => q[Paul G Webster <paul@daemonrage.net>]
#     BUILD_REQUIRES => {  }
#     NAME => q[POE::SAPI::HandySubs]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/POE/SAPI/HandySubs.pm]
...
DIRFILESEP = /
DFSEP = $(DIRFILESEP)
NAME = POE::SAPI::HandySubs
NAME_SYM = POE_SAPI_HandySubs
VERSION = 0.03
...
MAKE = make
FULLEXT = POE/SAPI/HandySubs
BASEEXT = HandySubs
PARENT_NAME = POE::SAPI
DLBASE = $(BASEEXT)
VERSION_FROM = lib/POE/SAPI/HandySubs.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/POE/SAPI/HandySubs.pm
...
TO_INST_PM = lib/POE/SAPI/HandySubs.pm

PM_TO_BLIB = lib/POE/SAPI/HandySubs.pm \
	blib/lib/POE/SAPI/HandySubs.pm
...
DISTNAME = POE-SAPI-HandySubs
DISTVNAME = POE-SAPI-HandySubs-0.03
...
manifypods : pure_all  \
	lib/POE/SAPI/HandySubs.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/POE/SAPI/HandySubs.pm $(INST_MAN3DIR)/POE::SAPI::HandySubs.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               POE-SAPI-HandySubs' >> META_new.yml
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/POE/SAPI/HandySubs.pm blib/lib/POE/SAPI/HandySubs.pm 
